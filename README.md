...
## Models
Note that wan-2-2-animate-comfyui-gradio.ipynb uses q6_k, and wan-2-2-animate-comfyui.ipynb notebook uses q3_k_m by default. If you prefer to use a different model for a notebook, you have to change the model name in the link_map within the notebook code.
